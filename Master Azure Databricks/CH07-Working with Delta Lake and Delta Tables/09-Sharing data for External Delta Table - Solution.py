...
(flight_time_df.coalesce(1)
    ...
    .format("delta")
    .mode("overwrite")
    .save("abfss://dbfs-container@egeahsa.dfs.core.windows.net/external/flight-time")
)

# COMMAND ----------

# MAGIC %fs ls abfss://dbfs-container@egeahsa.dfs.core.windows.net/external/flight-time
