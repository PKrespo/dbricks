...
# MAGIC URL 'abfss://dbfs-container@egeahsa.dfs.core.windows.net/external'
# MAGIC WITH (CREDENTIAL 'egeah-storage-credential')
...
(spark.read
    .format("delta")
    .load("abfss://dbfs-container@egeahsa.dfs.core.windows.net/external/flight-time")
    .display()
)
...
# MAGIC     DISTANCE INT
# MAGIC ) USING DELTA
# MAGIC LOCATION "abfss://dbfs-container@egeahsa.dfs.core.windows.net/external/flight-time"
