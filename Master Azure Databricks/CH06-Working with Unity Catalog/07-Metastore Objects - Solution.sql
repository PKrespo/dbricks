...
GRANT USE CATALOG ON CATALOG dev TO `dbricksGroup`;
GRANT ALL PRIVILEGES ON DATABASE dev.demo_db to `dbricksGroup`;
...
-- MAGIC %fs ls abfss://dbfs-container@egeahsa.dfs.core.windows.net/
